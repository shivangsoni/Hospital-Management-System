...
$query = $DBcon->query("SELECT * FROM reception WHERE R_email=".$_SESSION['userSession']);
...
<title>Welcome - <?php echo $userRow['R_name']; ?></title>
      ...
      <div class="container">
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp; <?php echo $userRow['R_name']; ?></a></li>
            <li><a href="logout_reception.php?logout"><span class="glyphicon glyphicon-log-out"></span>&nbsp; Logout</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
...
<a href="register_doctor_patient.php"><h3>Update doctor_patient table</h3></a>
</body>
</html>
